...
const CATALOG = [
  ...
  { id: '2', name: 'MRSAM / Barak-8', category: 'MEDIUM_RANGE', cost: 50, maintenance: 21.9, range: 100, accuracy: 85, color: '#f59e0b', owned: 4, maxLevel: 5 },
  { id: '3', name: 'Akash-NG', category: 'MEDIUM_RANGE', cost: 5, maintenance: 10.5, range: 80, accuracy: 85, color: '#f59e0b', owned: 6, maxLevel: 5 },
  { id: '4', name: 'QRSAM', category: 'SHORT_RANGE', cost: 3, maintenance: 5.2, range: 30, accuracy: 82, color: '#00ff88', owned: 8, maxLevel: 5 },
  { id: '5', name: 'Igla-S', category: 'VERY_SHORT_RANGE', cost: 0.06, maintenance: 0.4, range: 6, accuracy: 65, color: '#00b4d8', owned: 24, maxLevel: 3 },
  { id: '6', name: 'DRDO Anti-Drone', category: 'ANTI_DRONE', cost: 0.5, maintenance: 0.9, range: 3, accuracy: 75, color: '#a855f7', owned: 4, maxLevel: 4 },
  { id: '7', name: 'Arudhra AESA', category: 'RADAR', cost: 25, maintenance: 7.0, range: 500, accuracy: 0, color: '#6366f1', owned: 3, maxLevel: 3 },
];

const TECH_TREE = [
  { level: 1, name: 'Basic Systems', unlocked: true, systems: ['Igla-S', 'OSA-AKM'], color: '#4b5563' },
  { level: 2, name: 'Modern SHORAD', unlocked: true, systems: ['QRSAM', 'Mistral'], color: '#00b4d8' },
  { level: 3, name: 'Medium Range', unlocked: true, systems: ['Akash', 'Akash-NG', 'MRSAM'], color: '#f59e0b' },
